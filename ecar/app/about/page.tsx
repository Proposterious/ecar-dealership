...
function About() {
    return ( 
        <section className='n-xs:px-4 n-md:px-8 n-lg:px-12 pb-12 bg-slate-100'>
            <header className='w-fit n-xs:mx-auto n-md:ml-24 n-xs:pb-4 n-md:pb-8 n-lg:pb-12'>
            ...
            <div id='about' className='n-md:ml-24 n-md:pb-6 | font-light n-xs:text-normal n-md:text-lg'>
                <p className='n-xs:w-4/5 n-xs:mx-auto n-xs:my-2 n-xs:line-clamp-6 n-xs:bg-slate-300 n-xs:p-1 | n-md:w-3/5 n-md:mx-0 n-md:my-3 n-md:line-clamp-none'>
